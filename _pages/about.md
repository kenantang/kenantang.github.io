...
4. LLM-based **language learning** assistants. Here is a high-quality [LLM-generated dictionary](https://daily-dictionary.streamlit.app/) I use every day to learn Korean and Spanish.

Please see my [Google Scholar page](https://scholar.google.com/citations?user=xgU9VfcAAAAJ&hl=en) for the full publication list. I am also actively sharing datasets and blog posts from my research on [Hugging Face](https://huggingface.co/kenantang) and [Substack](https://substack.com/@kenantang).
...
[[Resume (March 30, 2026)]](files/KenanTangResume_Website_033026.pdf)